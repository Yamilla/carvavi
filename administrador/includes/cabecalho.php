    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="?secao=cadastrarunidade">Cadastrar unidade básica de saúde</a></li>
            <li><a class="dropdown-item" href="?secao=unidadecadastrada">Unidades básicas de saúde cadastradas</a></li>
          </ul>
        </li>
      </ul>
