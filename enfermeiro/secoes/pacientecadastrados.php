                    ...
                    ?>
                        <form method="post">
                            <tr>
                                ...
                                <td><a class="btn btn-outline-warning" href="<?= "?secao=alterarpaciente&id=" . $row['id_paciente'] . "&nome=" . $row['nome_paciente'] . "&cpf=" . $row['cpf'] . "&rg=" . $row['rg'] ."&orgao=".$row['orgao_expedidor']. "&sus=" . $row['sus'] . "&data=" . $row['nascimento'] . "&telefone=" . $row['telefone'] . "&rua=" . $row['rua'] . "&numero=" . $row['numero'] . "&bairro=" . $row['bairro'] . "&cidade=" . $row['cidade'] . "&estado=" . $row['estado'] . "&cep=" . $row['cep']  ?>" role="button">Alterar</a></td>
